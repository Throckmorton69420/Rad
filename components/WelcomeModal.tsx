...
const WelcomeModal: React.FC<WelcomeModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <FocusTrap active={isOpen}>
      <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-[var(--z-notification)]" role="dialog" aria-modal="true" aria-labelledby="welcome-title">
