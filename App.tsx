    ...
    <div className="h-full w-full bg-transparent text-[var(--text-primary)] flex flex-col">
      ...
      <div className="flex-grow lg:pl-80 flex flex-col min-h-0">
        ...
        <main className="flex-1 overflow-y-auto min-h-0">
            <div className="pt-3 md:pt-6 pl-[calc(0.75rem+env(safe-area-inset-left))] pr-[calc(0.75rem+env(safe-area-inset-right))] flex flex-col pb-[calc(6rem+env(safe-area-inset-bottom))]">
