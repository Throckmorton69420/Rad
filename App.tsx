  ...
  const SidebarContent = (
      <aside className={`w-80 bg-[var(--background-secondary)] text-[var(--text-secondary)] border-r border-[var(--separator-primary)] flex flex-col h-full`}>
        <div className="flex-grow flex flex-col min-h-0">
          <div className="flex-grow overflow-y-auto isolated-scroll pr-5 pl-[calc(0.75rem+env(safe-area-inset-left))] pt-[calc(0.75rem+env(safe-area-inset-top))] pb-[calc(4rem+env(safe-area-inset-bottom))]">
