...
progressPerDomain: Partial<Record<Domain, { totalMinutes: number; completedMinutes: number }>>;
startDate: string;
endDate: string;
...
export interface ShowConfirmationOptions extends Omit<ConfirmationModalProps, 'isOpen' | 'onConfirm' | 'onClose'> { }
